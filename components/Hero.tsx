...
const Hero: React.FC = () => {
  return (
    <section
      id="hero"
      className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-honra-black text-white"
    >
      ...
      <div className="relative z-20 container mx-auto px-4 text-center mt-16">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-honra-red/50 rounded-full px-4 py-2 mb-8 animate-fade-in-up">
          ...
          <span className="text-sm font-semibold tracking-wider text-gray-200">
            FORNECEDOR OFICIAL CHECKMAT BRASIL
          </span>
        </div>
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 font-light leading-relaxed animate-fade-in-up delay-200">
          A referência brasileira em Kimonos personalizados. Qualidade testada
          nos maiores tatames do mundo. Performance, durabilidade e estilo para
          Jiu-Jitsu, Karatê, Taekwondo e Hapkido estilo para todas as artes
          marciais.
        </p>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 animate-bounce">
        <a
          href="#categories"
          className="text-white/50 hover:text-honra-red transition-colors"
        >
